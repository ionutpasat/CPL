...
public class Test {
    ...
    public static void task12() throws IOException {
        ...
        var listener = new CPLangParserBaseListener() {
		     ...
		     */
			@Override
			public void exitFormal(CPLangParser.FormalContext context) {
				varDefs++;
			}

			@Override
			public void exitVarDef(CPLangParser.VarDefContext context) {
				varDefs++;
			}

			@Override
			public void exitFuncDef(CPLangParser.FuncDefContext context) {
				funcDefs++;
			}
